...
<div style="font-size: 25px; margin-left: 440px; margin-top: 100px;">
...
<div class="col-md-6">
![](nyu_grad.JPEG){height="400px"}
</div>
</div>

<div style="margin-top: 600px; margin-left:50px;">
<div class="col-md-6">
![My cat Ivy :)](ivy_photo.jpg){height="300px"}
</div>
...
<div class="col-md-4">
![A penguin I whittled](whittle_penguin.JPG){height="150px"}
</div>
</div>
<div style="margin-left: 600px">
<div class="col-md-6">
![A pig I whittled](whittle_pig.jpg){height="150px"}
</div>
</div>
</div>
</div>
